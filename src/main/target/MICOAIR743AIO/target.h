...
#define TARGET_BOARD_IDENTIFIER "MAIO"

#define USBD_PRODUCT_STRING  "MICOAIR743AIO"
...
#define VBAT_SCALE_DEFAULT          2112
#define CURRENT_METER_SCALE         707

#define DEFAULT_FEATURES        (FEATURE_VBAT | FEATURE_CURRENT_METER | FEATURE_OSD | FEATURE_TELEMETRY | FEATURE_LED_STRIP)
