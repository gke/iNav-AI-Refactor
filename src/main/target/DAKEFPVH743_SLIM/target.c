...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM2,  CH1, PA0,   TIM_USE_OUTPUT_AUTO, 0, 4),   // S5
    DEF_TIM(TIM2,  CH2, PA1,   TIM_USE_OUTPUT_AUTO, 0, 5),   // S6
    DEF_TIM(TIM2,  CH3, PA2,   TIM_USE_OUTPUT_AUTO, 0, 6),   // S7
    DEF_TIM(TIM2,  CH4, PA3,   TIM_USE_OUTPUT_AUTO, 0, 7),   // S8 DMA None
    DEF_TIM(TIM4,  CH1, PD12,  TIM_USE_OUTPUT_AUTO, 0, 11),  // S9 - unique DMA opt, was 0 (collided with TIM1 CH1 S1 on DMA1 Stream0)
    DEF_TIM(TIM4,  CH2, PD13,  TIM_USE_OUTPUT_AUTO, 0, 12),  // S10
    DEF_TIM(TIM4,  CH3, PD14,  TIM_USE_OUTPUT_AUTO, 0, 13),  // S11
    DEF_TIM(TIM4,  CH4, PD15,  TIM_USE_OUTPUT_AUTO, 0, 14),  // S12
