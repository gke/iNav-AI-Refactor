...
typedef struct barometerConfig_s {
    ...
    uint16_t baro_calibration_tolerance;    // Baro calibration tolerance (centimetres at sea level)
    float baro_temp_correction;             // Baro temperature correction value (centimetres/K)
} barometerConfig_t;
